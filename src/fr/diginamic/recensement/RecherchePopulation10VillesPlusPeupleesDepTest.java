...
class RecherchePopulation10VillesPlusPeupleesDepTest{
	...
	@Test
	void recherche2VillesPlusPeupleesDepartement_2LignesSimples() {
...
//		resultatCleDepPlusPleuples[1] = new Departement("01", 1400);
		...
		recensement.ajouteVille("84;Auvergne-Rhône-Alpes;01;1;10;011;Anglefaible;1 124;18;1 100;");

		recensement.ajouteVille("84;Auvergne-Rhône-Alpes;01;1;10;012;VilleMax2;1 124;18;1 500;");
		recensement.ajouteVille("84;Auvergne-Rhône-Alpes;01;1;10;013;VilleMax1;1 124;18;1 600;");

		recensement.ajouteVille("84;Auvergne-Rhône-Alpes;03;1;10;014;Angle;1 124;18;1 200;");
		recensement.ajouteVille("84;Auvergne-Rhône-Alpes;04;1;10;015;Anglef;1 124;18;1 800;");
...
//		assertArrayEquals(resultatCleDepPlusPleuples, recherchePop10Departement.rechercher(nbDepRecherche));
		assertEquals("013", recherchePop10Departement.rechercher(nbDepRecherche)[0].getCodeDepartement());
		assertEquals(1600, recherchePop10Departement.rechercher(nbDepRecherche)[0].getPopulationTotale());
		assertEquals("012", recherchePop10Departement.rechercher(nbDepRecherche)[1].getCodeDepartement());
		assertEquals(1500, recherchePop10Departement.rechercher(nbDepRecherche)[1].getPopulationTotale());
